...
myst:
  html_meta:
    "description": "A Plone add-on providing a Video content type that supports external video sources"
    "property=og:description": "A Plone add-on providing a Video content type that supports external video sources"
    "property=og:title": "Video Support for Plone"
    "keywords": "Video Support for Plone, documentation, A Plone add-on providing a Video content type that supports external video sources"
---

# Video Support for Plone

Welcome to the documentation for Video Support for Plone!
