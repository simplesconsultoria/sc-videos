...
# Video Support for Plone build configuration file
...
project = "Video Support for Plone"
...
htmlhelp_basename = "Video Support for PloneDocumentation"
...
latex_documents = [
    (
        "index",
        "Video Support for PloneDocumentation.tex",
        "Video Support for Plone Documentation",
